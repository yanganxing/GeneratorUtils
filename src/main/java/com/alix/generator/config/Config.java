...
import com.alix.generator.consts.GeneratorConst;
import com.alix.generator.exception.GeneratorException;
import com.alix.generator.util.DbUtil;
import lombok.Data;
...
public class Config {
     ...
     * 根包名
     */
    private String basePackage = "com.alix.infosystem";
    /**
     * beans包名
     */
    private String beansPackage = basePackage + ".application.model";
    /**
     * mapper接口包名
     */
    private String mapperPackage = basePackage + ".application.mapper";
